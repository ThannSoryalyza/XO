...
<div class="admin-layout">
    <aside class="admin-sidebar">
        ...
        <div class="admin-brand">
            <img src="{{ asset('img/XO.png') }}" alt="XO United">
        ...
        <ul class="admin-nav nav flex-column">
            ...
            <li>
                <a href="#messages-sec" class="nav-link">
                    ...
                    <span class="sidebar-inbox-badge {{ $new_messages_count > 0 ? '' : 'd-none' }}" id="sidebar-inbox-badge">{{ $new_messages_count }}</span>
                </a>
            </li>
        </ul>
        <div class="admin-sidebar-footer">
            <a href="{{ url('/') }}" target="_blank"><i class="bi bi-box-arrow-up-right"></i> View Public Site</a>
    ...
    <main class="admin-main">
            ...
            <div class="admin-stats">
                <div class="admin-stat-card">
                    ...
                    <div>
                        ...
                        <p class="admin-stat-value">{{ $players_count }}</p>
                ...
                <div class="admin-stat-card">
                    ...
                    <div>
                        ...
                        <p class="admin-stat-value">{{ $managers_count }}</p>
                ...
                <div class="admin-stat-card">
                    ...
                    <div>
                        ...
                        <p class="admin-stat-value">{{ $matches_count }}</p>
                ...
                <div class="admin-stat-card">
                    ...
                    <div>
                        ...
                        <p class="admin-stat-value">{{ $total_messages_count }}</p>
                        <p class="admin-stat-sub">{{ $new_messages_count }} unread</p>
                    </div>
                </div>
            </div>
            ...
            @include('admin.components.league-standings')
