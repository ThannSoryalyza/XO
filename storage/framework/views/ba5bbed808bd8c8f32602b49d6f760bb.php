<?php $__env->startSection('title', 'About Us | XO United'); ?>

<?php $__env->startSection('content'); ?>
<section class="about-page">
    <div class="about-hero">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <img src="<?php echo e(asset('img/XO.png')); ?>" alt="XO United" class="about-hero-logo">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div class="about-intro-grid">
            ...
            <div class="about-intro-photo">
                <img src="<?php echo e(asset('img/team.jpg')); ?>" alt="XO United squad" loading="lazy">
        ...
        <div class="about-cta">
            ...
            <div class="about-cta-actions">
                <a href="<?php echo e(route('player')); ?>" class="home-btn home-btn--primary">View Players</a>
                <a href="<?php echo e(route('matches')); ?>" class="home-btn home-btn--outline">Upcoming Matches</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\CG-HENG\Documents\Xounited\resources\views/about.blade.php ENDPATH**/ ?>