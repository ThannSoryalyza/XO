    ...
    <div class="row">
        <nav class="col-md-3 col-lg-2 sidebar d-md-block collapse">
            <div class="d-flex align-items-center mb-4 px-2">
                <img src="<?php echo e(asset('XO.png')); ?>" alt="Logo" class="me-2" style="width: 40px; height: 40px; object-fit: contain;">
        ...
        <main class="col-md-9 col-lg-10 main-content px-md-4 py-4">
            ...
            <div class="row mb-4">
                <div class="col-xl-3 col-md-6 mb-4"><div class="card card-counter shadow-sm h-100 py-2 bg-white" style="border-left-color: #0d6efd;"><div class="card-body"><div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Squad Players</div><div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($players_count); ?> Registered</div></div></div></div>
                <div class="col-xl-3 col-md-6 mb-4"><div class="card card-counter shadow-sm h-100 py-2 bg-white" style="border-left-color: #198754;"><div class="card-body"><div class="text-xs font-weight-bold text-success text-uppercase mb-1">Staff</div><div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($managers_count); ?> Active</div></div></div></div>
                <div class="col-xl-3 col-md-6 mb-4"><div class="card card-counter shadow-sm h-100 py-2 bg-white" style="border-left-color: #0dcaf0;"><div class="card-body"><div class="text-xs font-weight-bold text-info text-uppercase mb-1">Match Fixtures</div><div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($matches_count); ?> Scheduled</div></div></div></div>
                <div class="col-xl-3 col-md-6 mb-4"><div class="card card-counter shadow-sm h-100 py-2 bg-white" style="border-left-color: #ffc107;"><div class="card-body"><div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Inbox Logs</div><div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($total_messages_count); ?> Inquiries</div></div></div></div>
            </div>
...
<?php /**PATH C:\Users\CG-HENG\Documents\testing\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>